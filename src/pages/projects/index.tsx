...
export function ProjectListPage(props: ProjectListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProjects({
        relations: ['organization', 'contractor.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('contractor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'contractor',
          header: 'Contractor',
          accessorKey: 'contractor',
          cell: ({ row: { original: record } }: any) => record?._count?.contractor,
        }
      : null,
